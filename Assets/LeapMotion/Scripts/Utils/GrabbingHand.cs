...
public class GrabbingHand : MonoBehaviour {
  ...
  protected void OnRelease() {
    if (active_object_ != null) {
      ...
      StartCoroutine(ReturnCollisions(gameObject, active_object_.gameObject));
    }
    active_object_ = null;
  ...
  IEnumerator ReturnCollisions(GameObject gameObj1, GameObject gameObj2)
  {
        yield return new WaitForSeconds(.5f);
        Leap.Utils.IgnoreCollisions(gameObj1, gameObj2, false);
  }
